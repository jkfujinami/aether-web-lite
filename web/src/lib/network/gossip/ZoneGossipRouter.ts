import type { IPeerManager, PeerId, GossipPacket, P2PMessage, StemPacket, IMessageDispatcher } from '../../types';
...
export class ZoneGossipRouter {
  ...
  constructor(peerManager: IPeerManager, dispatcher: IMessageDispatcher, zoneManager: ZoneManager) {
